...
public class FCMPS_CLS_AutoGenerateRccpPlan_1501SC {	
	public void do_Rccp(
			String FA_NO,
			String config_xml,
			int FORE_PLAN_WEEKS,
...
//    	cls_GenerateRccpPlan.setSH_NOT_PLAN("FEAT,FEAT K,RALENCLOG,RALENCLOGK,SPEC,SPEC VENT");
    	...
    	cls_GenerateRccpPlan.setSH_NOT_PLAN("FEAT,FEAT K,RALENCLOG,RALENCLOGK,SPEC,SPEC VENT,CC OLAF CLOG,CCAVNGRSIIICLG,CCBATMANCLOGK,CCDORABALLETCLG,CCFROZENCLOG," +
