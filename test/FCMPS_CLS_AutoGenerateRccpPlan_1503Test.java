...
public class FCMPS_CLS_AutoGenerateRccpPlan_1503Test extends TestCase {
	String FOS_File="";
	String config_xml="";
	String FA_NO="FIC";
...
//    	FCMPS_CLS_AutoGenerateRccpPlanTest.doPublish("1421SC", "N", conn);
    	try {
        	FCMPS_CLS_AutoGenerateRccpPlan_1503 rccp1452=new FCMPS_CLS_AutoGenerateRccpPlan_1503();    	
