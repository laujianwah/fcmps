...
public class FCMPS_CLS_AutoGenerateRccpPlan_1505 {	
	public void do_Rccp(
			String FA_NO,
			String config_xml,
			int FORE_PLAN_WEEKS,
		...
		String PLAN_NO="1505SC_12";
	
		System.out.println("======================================開始排入1505SC================================");
...
//    	if(1==1) return;
    	...
    	cls_GenerateRccpPlan.setPLAN_PRIORITY_TYPE("1");
    	cls_GenerateRccpPlan.set_ReGenerateRccpPlan(true);
    	cls_GenerateRccpPlan.setWEEK_MAX_CAP_QTY(300000);
