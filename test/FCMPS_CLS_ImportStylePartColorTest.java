...
public class FCMPS_CLS_ImportStylePartColorTest extends TestCase {
	String PLAN_File="F:/臨時文件/2015/20150317/FIC型体配色.xls";
	String FA_NO="FIC";
	...
	private void Import(String PLAN_File,String config_xml) {   
		FCMPS_CLS_Import_Style_Part_Color cls_Import=new FCMPS_CLS_Import_Style_Part_Color();
