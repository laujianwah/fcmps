...
public class FCMPS_CLS_AutoGenerateRccpPlan_1502 {	
	public void do_Rccp(
			String FA_NO,
			String config_xml,
			int FORE_PLAN_WEEKS,
		...
		String PLAN_NO="1502SC";
		
		System.out.println("======================================開始排入1502SC================================");
    	...
    	cls_GenerateRccpPlan.setPLAN_PRIORITY_TYPE("1");
    	cls_GenerateRccpPlan.set_ReGenerateRccpPlan(true);
    	cls_GenerateRccpPlan.setWEEK_MAX_CAP_QTY(168000);
