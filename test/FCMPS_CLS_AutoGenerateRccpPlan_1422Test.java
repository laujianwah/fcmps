...
public class FCMPS_CLS_AutoGenerateRccpPlan_1422Test extends TestCase {
	String FOS_File="";
	String config_xml="";
	String FA_NO="FIC";
	...
	public void test_1422() {
    	...
    	FCMPS_CLS_AutoGenerateRccpPlanTest.doPublish("1502ZD_16", "N", conn);
//    	FCMPS_CLS_AutoGenerateRccpPlanTest.doPublish("1424ZC", "N", conn);
//    	FCMPS_CLS_AutoGenerateRccpPlanTest.doPublish("1421SC", "N", conn);
    	
//    	FCMPS_CLS_AutoGenerateRccpPlan_1425 rccp1422=new FCMPS_CLS_AutoGenerateRccpPlan_1425();    	
