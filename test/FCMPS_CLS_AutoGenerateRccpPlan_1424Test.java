...
import fcmps.ui.FCMPS_CLS_GenerateRccpPlan20141111;

import junit.framework.TestCase;

public class FCMPS_CLS_AutoGenerateRccpPlan_1424Test extends TestCase {
	String FOS_File="";
	String config_xml="";
	String FA_NO="FIC";
	int maxColorCount=5;  //型體每周的配色個數
	int FORE_PLAN_WEEKS=8; //可提前周數
...
//    	FCMPS_CLS_AutoGenerateRccpPlanTest.doPublish("1424ZD", "N", conn);
    	FCMPS_CLS_AutoGenerateRccpPlanTest.doPublish("1423ZC", "N", conn);
    	FCMPS_CLS_AutoGenerateRccpPlanTest.doPublish("1423SC", "N", conn);
