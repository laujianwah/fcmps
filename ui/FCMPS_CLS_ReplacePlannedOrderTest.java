...
public class FCMPS_CLS_ReplacePlannedOrderTest extends TestCase {
	Connection ConnectionFVI=null;
	
	public void test_Replace() {
		String path="";
		String package_path[]=FCMPS_CLS_ReplacePlannedOrderTest.class.getPackage().toString().split(" ");
    	...
    	String config_xml=path+"/FTDB06.cfg.xml";
    	
    	Connection conn=getConnection(config_xml);
    	
    	doQuitStock("FIC",false,conn,config_xml);
